...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const [authState, setAuthState] = useState<{ loggedIn: boolean | null; isAdmin?: boolean }>({
    loggedIn: null
  })
          ...
          <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            {authState.loggedIn === null ? (
              ...
              <div className="space-x-4 flex items-center">
                ...
                <a href="/songs" className="text-gray-700 hover:text-gray-900">
                  My Library
                </a>
                <a href="/quiz" className="text-gray-700 hover:text-gray-900">
                  Quiz
                </a>
                <a href="/leaderboard" className="text-gray-700 hover:text-gray-900">
                  Leaderboard
                </a>
                {/* NEW LINK BELOW */}
